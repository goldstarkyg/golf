 ...
 * @type {string}
 */
var SERVER = 'http://111.231.243.52/interface.php';//这里需要改成您实际搭建的 PHP 后台服务地址
 ...
 * @type {number}
 */
var sdkAppID    = 1400082689; //请根据您的情况自行配置，这里可以不填，分享链接会带上这个参数，页面可以从链接中获取。
var accountType = 24951; //请根据您的情况自行配置，这里可以不填，分享链接会带上这个参数，页面可以从链接中获取。
 ...
 */
var loginInfo = {
    'sdkAppID': '1400082689', //用户所属应用id
    'appIDAt3rd': '1400082689', //用户所属应用id
    'accountType': '24951', //用户所属应用帐号类型
    'identifier': 'qqqq1111', //当前用户ID,必须是否字符串类
    'identifierNick': 'qqqq1111', //当前用户昵称
