...
<ul class="nav nav-tabs">
    <!--<li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('ugcvideo', array('op' => 'post'));?>">Add Video</a></li>-->
    <li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('ugcvideo', array('op' => 'display'));?>">Video List</a></li>
</ul>
<style>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php  echo $this->createWebUrl('ugcvideo', array('file_id' => $item['file_id'],'op' => 'post'))?>" style="color:#333;"><?php  echo $item['title'];?></a>
                </td>
