...
<ul class="nav nav-tabs">
    <li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('article', array('op' => 'post'));?>">添加文章</a></li>
    <li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('article', array('op' => 'display'));?>">文章列表</a></li>
</ul>
<style>
