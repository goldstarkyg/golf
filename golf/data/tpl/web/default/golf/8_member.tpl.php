...
<?php  if($operation != 'credit_record' && $do != 'credit_stat') { ?>
<ul class="nav nav-tabs">
    <li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('member', array('op' => 'display'))?>">会员列表</a></li>
    <?php  if($operation == 'post') { ?><li class="active"><a href="<?php  echo $this->createWebUrl('member', array('op' => 'post','uid' => $uid))?>">编辑会员资料</a></li><?php  } ?>
    <li <?php  if($operation == 'add') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('member', array('op' => 'add'))?>">添加会员</a></li>
</ul>
<?php  } else { ?>
<ul class="nav nav-tabs">
    <li <?php  if($operation  == 'credit_stat') { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('member', array('type' => 1, 'uid' => $uid ,'op'=>'credit_stat'))?>">数据概况</a></li>
    <li <?php  if($operation  == 'credit_record' &&  $type == 'credit1') { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('member', array('type' => 'credit1', 'uid' => $uid, 'op'=>'credit_record'));?>">积分日志</a></li>
    <li <?php  if($operation  == 'credit_record' &&  $type == 'credit2') { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('member', array('type' => 'credit2', 'uid' => $uid,'op'=>'credit_record'));?>">余额日志</a></li>
        ...
        <div class="table-responsive panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th style="min-width:100px;">Tuid</th>
                    <th style="min-width:100px;">VIP</th>
                    <th>余额/积分</th>
                ...
                <tr>
                    ...
                    <td><?php  echo $li['tencentuserid'];?></td>
                    <td><?php  if($li['vip'] == '1' ) { ?> Yes <?php  } else { ?> No<?php  } ?></td>
                    <td>
                    ...
                    <td class="text-right" style="overflow:visible;">
                        <div class="btn-group">
                            ...
                            <a href="<?php  echo $this->createWebUrl('member',array('uid' => $li['uid'],'op'=>'post'))?>" title="编辑" class="btn btn-default">编辑</a>
                            <a href="<?php  echo $this->createWebUrl('member',array('uid' => $li['uid'], 'type' => 1,'op'=>credit_stat))?>" title="日志" class="btn btn-success">日志</a>
                        </div>
                    </td>
                </tr>
                <?php  } } ?>
...
<script>
    require(['trade', 'bootstrap'], function(trade){
        ...
        $('.user-group').click(function(){
            ...
            $.post("<?php  echo $this->createWebUrl('member', array('op'=>'group'));?>", {uid: uid, id: id}, function(data){
                if(data != 'success') {
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <?php  echo tpl_fans_form('notice',$profile['notice']);?>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">Dynamic</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php  echo tpl_fans_form('dynamic',$profile['dynamic']);?>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-4 col-md-3 col-lg-2 control-label">文章类别</label>
                    <div class="col-sm-8 col-xs-12">
                        <?php  echo tpl_form_field_category_2level('category', $parent, $children, $profile['pcate'], $profile['ccate'])?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            $(function() {
                ...
                $('#address').on('click', ".isdefault",function () {
                    ...
                    var id = $(this).data('id');
                    var obj = $(this);
                    $.post("<?php  echo $this->createWebUrl('member' ,array('op' => 'post','op1'=>'isdefault'))?>", {uid : uid, id: id}, function(data) {
                ...
                $('#address').on('click', '.deleteaddr', function () {
                    ...
                    var id = $(this).data('id');
                    var obj = $(this);
                    $.post("<?php  echo $this->createWebUrl('member', array('op'=>'post','op1' => 'del'));?>", {id : id}, function(data) {
                        if (data.message.errno) {
                ...
                $('#submitaddr').click(function () {
                    ...
                    $('#myModal').modal('hide');
                    var id = $(this).data('id');
                    var op1 = $(this).data('op');
                    var op = 'post';
                    $.post("./index.php?c=site&a=entry&do=member&op1="+op1+"&op="+op, {province : province, city : city, district : district, detail : detail, uid : uid, name : name, code : code, phone : phone, id : id}, function(data) {
...
<form action="" method="post" class="form-horizontal" role="form" id="form1">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">Tencent User Id</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" name="tencentuserid" value="" class="form-control"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">手机号</label>
                ...
                fields: {
                    ...
                    mobile: {
                        validators: {
                            ...
                            remote: {
                                url: "<?php  echo $this->createWebUrl('member', array('op'=>'add'));?>",
                    ...
                    tencentuserid: {
                        validators: {
                            notEmpty: {
                                message: 'Tencent user can not empty.'
                            },
                            remote: {
                                url: "<?php  echo $this->createWebUrl('member',array('op'=>'add'));?>",
                                data: function(validator) {
                                    return {
                                        type: 'tencentuserid',
                                        data: validator.getFieldElements('tencentuserid').val()
                                    };
                                },
                                message: 'This tencent uer id exist already.'
                            }
                        }
                    },
                    password: {
...
<?php  if($operation == 'credit_record') { ?>
<div class="panel panel-default">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin: -1em -1em 1em -1em;">
        <div class="navbar-header">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li <?php  if($_GPC['type'] == 1) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('member', array('uid' => $uid, type => 1,'op'=>'credit_stat'));?>">今日</a></li>
                <li <?php  if($_GPC['type'] == -1) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('member', array('uid' => $uid, type => -1,'op'=>'credit_stat'));?>">昨日</a></li>
