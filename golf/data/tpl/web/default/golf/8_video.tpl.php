...
<ul class="nav nav-tabs">
    <li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('video', array('op' => 'post'));?>">Add Video</a></li>
    <li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('video', array('op' => 'display'));?>">Video List</a></li>
</ul>
<style>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td style="text-align:right; position:relative;">
                    ...
                    <a href="<?php  echo $this->createWebUrl('article' , array('id' => $item['id'],'op' => 'post'))?>" title="编辑">编辑</a>&nbsp;-&nbsp;
                    <a onclick="return confirm('此操作不可恢复，确认吗？'); return false;" href="<?php  echo $this->createWebUrl('article' , array('id' => $item['id'],'op'=>'delete'))?>" title="删除">删除</a>
                </td>
            </tr>
            <?php  } } ?>
            </tbody>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <p class="form-control-static"><a href="<?php  echo $_W['siteroot'];?>/app/index.php?c=golfview&a=article&do=detail&id=<?php  echo $item['id'];?>&i=<?php  echo $_W['uniacid'];?>" target="_blank"><?php  echo $_W['siteroot'];?>/app/index.php?c=site&a=golfview&do=detail&id=<?php  echo $item['id'];?>&i=<?php  echo $_W['uniacid'];?></a></p>
