                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <select name="type" class="form-control" >
                            ...
                            <option value="1" <?php  if($category['type'] == '1' ) { ?> selected <?php  } ?>>Dynamic</option>
                            <option value="2" <?php  if($category['type'] == '2' ) { ?> selected <?php  } ?> >Static</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">Static Type</label>
                    <div class="col-sm-9 col-xs-12">
                        <select name="type_value" class="form-control">
                            <option value="0">Select Below</option>
                            <option value="1" <?php  if($category['type_value'] == '1' ) { ?> selected <?php  } ?> >活动</option>
                            <option value="2" <?php  if($category['type_value'] == '2' ) { ?> selected <?php  } ?> >订场</option>
                            <option value="3" <?php  if($category['type_value'] == '3' ) { ?> selected <?php  } ?> >赛事</option>
                            <option value="4" <?php  if($category['type_value'] == '4' ) { ?> selected <?php  } ?> >差点</option>
                            <option value="5" <?php  if($category['type_value'] == '5' ) { ?> selected <?php  } ?> >球包直邮</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php  if($row['type'] == '1') { ?> Dynamic<?php  } ?>
                        <?php  if($row['type'] == '2') { ?>Static<?php  } ?>
                        </div>
                    </td>
                    <td>
                        <div class="type-parent">
                        <?php  if($row['type_value'] == '1') { ?> 活动 <?php  } ?>
                        <?php  if($row['type_value'] == '2') { ?> 订场<?php  } ?>
                        <?php  if($row['type_value'] == '3') { ?> 赛事<?php  } ?>
                        <?php  if($row['type_value'] == '4') { ?> 差点<?php  } ?>
                        <?php  if($row['type_value'] == '5') { ?> 球包直邮 <?php  } ?>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td><img src="./resource/attachment/<?php  echo $row['thumb'];?>" width='50' height="50" onerror="$(this).remove()" style='padding:1px;border: 1px solid #ccc;float:left;' />
                        <div class="type-child"><?php  echo $row['name'];?>&nbsp;&nbsp;   <?php  if($row['enabled']==1) { ?>
                        <span class='label label-success'>显示</span>
                        <?php  } else { ?>
                        <span class='label label-danger'>隐藏</span>
                        <?php  } ?></div></td>
