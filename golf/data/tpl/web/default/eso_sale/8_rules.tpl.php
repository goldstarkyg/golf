                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            ...
                            <label class="radio-inline"><input type="radio"  name="promotertimes" value="0" <?php  if($theone['promotertimes'] == 0) { ?> checked="checked"<?php  } ?> /> 管理员审核</label>
                            <div class="help-block">选择成为代理的条件，默认注册账号后需管理员通过才成为代理！</div>
                        </div>
                    </div>
                    <div class="form-group">
