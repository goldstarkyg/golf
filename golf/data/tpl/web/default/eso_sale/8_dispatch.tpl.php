...
<li <?php  if($operation == 'freight') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('dispatch',array('op' =>'freight'))?>">运费设置</a></li>
    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" onsubmit='return formcheck()'>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">运费（元）</label>
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="firstprice" id='firstprice' class="form-control" value="<?php  echo intval($firstprice['firstprice'])?>" />
                    </div>
                </div>
...
<script type="text/javascript">
    function formcheck() {
        if ($("#firstprice").isEmpty()) {
            Tip.focus("firstprice", "请输入运费金额!", "right");
            return false;
        }
        return true;
    }
