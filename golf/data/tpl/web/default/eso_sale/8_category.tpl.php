        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <label class="radio-inline">
                            <input type='radio' name='ishot' class="check" value=1' <?php  if($category['ishot']==1) { ?>checked<?php  } ?> /> 是
                        </label>
                        <label class="radio-inline">
                            <input type='radio' name='ishot' class="check" value=0' <?php  if($category['ishot']==0) { ?>checked<?php  } ?> /> 否
                        </label>
                    </div>
                </div>
            </div>
