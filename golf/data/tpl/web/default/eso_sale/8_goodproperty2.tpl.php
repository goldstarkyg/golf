...
<ul class="nav nav-tabs">
    <li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('goodproperty2', array('op' => 'post'))?>">Add proerty</a></li>
    <li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('goodproperty2', array('op' => 'display'))?>">Property List</a></li>
</ul>
