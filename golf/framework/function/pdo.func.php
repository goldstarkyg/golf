...
function pdo_update_table($table, $data = array(), $params = array(), $glue = 'AND') {
	return pdo()->update_table($table, $data, $params, $glue);
}
...
function pdo_insert_table($table, $data = array(), $replace = FALSE) {
	return pdo()->insert_table($table, $data, $replace);
}
...
function pdo_delete_table($table, $params = array(), $glue = 'AND') {
	return pdo()->delete_table($table, $params, $glue);
}
