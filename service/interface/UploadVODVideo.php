...
class UploadVODVideo extends AbstractInterface
{
...
//         $hls_play_url = "http://" . $bizid . ".liveplay.myqcloud.com/live/" .  $live_code . ".m3u8";
    	...
    	$ret = $dao_live->AddVODData($userid, $this->_args['file_id'],$this->_args['play_url'], $this->_args['title'],$this->_args['userinfo']);
    	if($ret != 0)
    	{
    		$this->_retValue =$ret;
